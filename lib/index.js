  ...
  app.use((req, res, next) => {
    ...
    res.md = async function(view, options) {
      ...
      if (!existsSync(`${process.cwd() + '/' + views_hbs}`)) {
        ...
        let { text: main_layout } = await http.get('https://raw.githubusercontent.com/k1-1960/express-md/main/src/views/.c/layouts/main.hbs');
        writeFileSync(`${process.cwd() + '/' + views_hbs}/layouts/main.hbs`, main_layout, 'utf8');

        let {text: expressmd_partial } = await http.get('https://raw.githubusercontent.com/k1-1960/express-md/main/src/views/.c/partials/expressmd.hbs');
